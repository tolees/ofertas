...
- 🌙【Impermeable IP68】Es adecuado para escenarios de uso diario de agua (por ejemplo, lavarse las manos, ducharse, llover...). Pero no se recomienda usarlo en agua caliente y agua de mar. Trate de no presionar el botón lateral del reloj cuando use agua, para evitar algunas situaciones especiales que hagan que el reloj entre al agua. Siempre puede buscar el servicio posventa utilizando el número de pedido de Amazon.
